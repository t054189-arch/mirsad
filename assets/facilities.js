...
(function (global) {
  ...
  global.MIRSAAD_FACILITIES = {
    ...
    statusOf: statusOf,
    /* حدود الكويت تقريبًا: عليها يُضبط الإطار الأوّل، فتملأ البلادُ
       الشاشةَ قريبةً بما يكفي لقراءة الطرق والمناطق. */
    BOUNDS: [[28.52, 46.55], [30.10, 48.43]],
    /* وحدود التجوال أوسع قليلًا، فلا تصطدم اليد بحافة البلاد */
    PAN_BOUNDS: [[27.95, 45.95], [30.65, 49.05]],
    CENTRE: [29.3100, 47.6800],
    ZOOM: 9,
    /* أبعد من هذا تصير الكويت نقطةً في الخليج. والكسر مقصود: على
       الشاشات القصيرة يحتاج ضبطُ البلاد كاملةً أقلَّ من الثامنة بقليل،
       فلو منعناه لاقتُطع طرفها. */
    MIN_ZOOM: 7.75
  };
})(window);
