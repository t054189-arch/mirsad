...
window.MIRSAAD_EN = {
  ...
  'gv.capital': 'Al Asimah',
  'sc.report': 'Final report',
  'pg.reportLead': 'A combined inspection report, ready to print or save.',
  'rp.demo': 'Demo data',
  'rp.about': 'Structure and inspection',
  'rp.site': 'Demo Bridge – Kuwait',
  'rp.type': 'Periodic inspection',
  'rp.part': 'Concrete bridge deck',
  'rp.user': 'Demo User',
  'rp.verdict': 'Finding and decision',
  'rp.finding': 'Finding',
  'rp.where': 'Location',
  'rp.level': 'Priority',
  'rp.ok': 'Approved',
  'rp.agent': 'Agent summary',
  'rp.agentNote': 'Likely a recurring finding — user review required. The result above comes from a fixed demonstration sequence, labelled “Demo AI result”.',
  'rp.shots': 'Inspection images',
  'rp.limit': 'AI-generated results are decision-support information and require user or professional review. MIRSAAD does not certify the safety of any structure.',
  'rp.made': 'Report date',
  'rp.back': 'Back to the record',
  'rp.open': 'Final report',
  'a.tourGo': 'See How MIRSAAD Works',
