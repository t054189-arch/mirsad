...
(function () {
  ...
  /* الرابط يجب أن يعيد الزائر إلى الموقع الذي سجّل منه — محليًا كان
     أو منشورًا — لا إلى عنوان واحد مكتوب في لوحة Supabase.

     نعيده إلى جذر الأصل (لا إلى المسار الكامل مثل ‎/index.html‎): الجذر
     يساوي Site URL دائمًا فيقبله الخادم بلا حاجة إلى إضافة كل مسار في
     قائمة Redirect URLs. ولمّا كانت صفحة البوّابة (index.html) تُخدَم من
     الجذر، فإن العودة إليه تُظهر شاشة «تم التحقق» نفسها. ولو بقي المسار
     الكامل غير مُدرَج في القائمة لردّ الخادم الزائر بخطأ بدل الجلسة،
     فلا تظهر الشاشة ويبدو الرابط معطّلًا. */
  function backHere() {
